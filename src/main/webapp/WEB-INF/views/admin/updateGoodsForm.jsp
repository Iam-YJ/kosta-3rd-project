...
<div class="insertOrdersForm" style="margin:20px 0px;">
	<div class="container">
		...
		<div class="contentSection border" style="padding : 10px;">
			<form action="${pageContext.request.contextPath}/admin/updateGoods/${registerGoods.regNo}" id="updateGoodsForm" method="post" enctype="multipart/form-data" >			
				<div class="row">
				...
				<div class="row" style="margin-top: 10px;">
					<div class="col-xl" style="margin: auto; text-align: left;">
						<textarea class="form-control" name="detail" rows="10" cols="" id="summernote">
				...
				<div class="row" style="margin-top: 10px;">
					<div class="col-xl" style="margin: auto; text-align: center;">
						<button type="button" class="btn btn-success" id="insertGoodsBtn">수정하기</button>
