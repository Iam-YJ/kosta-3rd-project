...
나의 장바구니 목록
	<c:forEach items="${list}" var="list">
		<div class="row border border-left-0 border-right-0">
			...
			<div class="col-xl-4" >
				<div class="row " style="font-size: 20px; padding: 50px;">
...
<div class="container">
	<div class="row border border-left-0 border-right-0">
		<div class="col-xl">
			<input type="button"  class="btn btn-outline-success row col-xl" onclick="buyCartGoods();"  value="전체 구매"> 
		</div>
	</div>
</div>
