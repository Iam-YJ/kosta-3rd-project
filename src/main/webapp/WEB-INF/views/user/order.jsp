			...
			<div class="buyerInfoSection">
				...
				<div class="ContentSection">
					<div class="row border border-left-0 border-right-0">
						...
						<div class="TD col-xl">${sessionScope.userList.name}</div>
					</div>
					<div class="row border border-left-0 border-right-0 border-top-0">
						<div class="TH col-xl-3">이메일</div>
						<div class="TD col-xl">${sessionScope.userList.email}</div>
					</div>
					<div class="row border border-left-0 border-right-0 border-top-0">
						<div class="TH col-xl-3">연락처</div>
						<div class="TD col-xl">${sessionScope.userList.phone}</div>
					</div>
				</div>
					...
					<div class="row border border-left-0 border-right-0">
						...
						<div class="TD col-xl">
							<input type="text" class="form-control" id="usr"
								value="${sessionScope.userList.name}">
						</div>
					</div>
					...
					<div class="row border border-left-0 border-right-0 border-top-0">
						...
						<div class="TD col-xl">
							<input type="text" class="form-control" id="phone"
								value="${sessionScope.userList.phone}">
						</div>
					</div>
				</div>
			</div>
			...
			<div class="priceInfoSection">
				...
				<div class="ContentSection">
					<div class="row border border-left-0 border-right-0">
						...
						<div class="TD col-xl">${totalPrice}원</div>
					</div>
					<div class="row border border-left-0 border-right-0 border-top-0">
				...
				<form action="" method="post" id="orderPay">
					<div class="row">
						<div class="hiddendInfo">
							<input type="hidden" id="shippingAddr" name="shippingAddr"
								value="${sessionScope.userList.addr}"> <input
								type="hidden" id="totalPrice" name="totalPrice"
								value="${buyMap.registerGoods.price * buyMap.cart.quantity +2500}">
							<input type="hidden" id="realPay" name="realPay" value="0">
							<input type="hidden" id="regNo" name="regNo"
								value="${buyMap.registerGoods.regNo}"> <input
								type="hidden" id="quantity" name="quantity"
								value="${buyMap.cart.quantity}"> <input type="hidden"
								id="unitPrice" name="unitPrice"
								value="${buyMap.registerGoods.price}"> <input
								type="hidden" id="unitTotalPrice" name="unitTotalPrice"
								value="${buyMap.registerGoods.price * buyMap.cart.quantity}">
							<input type="hidden" id="usingPoints" name="usingPoints" value=0>
							<input type="hidden" id="cartNo" name="cartNo"
								value="${buyMap.cart.cartNo}">
						</div>
						<div class="col-xl" style="text-align: center; margin: auto;">
