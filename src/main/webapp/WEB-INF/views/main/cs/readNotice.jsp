...
<SCRIPT language=javascript>
   $(function(){
	   $("input[value=수정하기]").click(function(){
		   ...
		   $("#requestForm").attr("action", "${pageContext.request.contextPath}/admin/updateNoticeForm");
		   $("#requestForm").submit();
	   })
	   
	   
	   $("input[value=삭제하기]").click(function(){
			   $("#requestForm").attr("action", "${pageContext.request.contextPath}/admin/deleteNotice");
			   $("#requestForm").submit();
	   })
...
<table align="center" cellpadding="5" cellspacing="2" width="600" border='1'>
    ...
    <tr>
        ...
        <td width="450" height="20" colspan="3">
        	<span style="font-size:9pt;"><b>${NoticeNo}</b></span>
        </td>
    </tr>
    <tr>
        <td width="100" height="20" >
        ...
        <td width="300" height="20">
        	<span style="font-size:9pt;"><b>${requestScope.RegDate}</b></span>
        </td>
    </tr>
    <tr>
        <td width="100" height="20">
        ...
        <td width="450" height="20" colspan="3">
        	<span style="font-size:9pt;"><b>${requestScope.notice.title}</b></span>
        </td>
    </tr>
    <tr>
        ...
        <span style="font-size:9pt;"><b><pre>${requestScope.notice.content}</pre></b></span></td>
    </tr>
