...
<form name="writeForm" method="post" action="${pageContext.request.contextPath}/admin/insertFAQ">
...
<table align="center" cellpadding="5" cellspacing="2" width="600" border="1" >
    ...
    <tr>
		...
		<input type=text name="question" size="30"></span></b></td>
    </tr>
    ...
    <tr>
        ...
        <td width="450" height="20" ><b><span style="font-size:9pt;">
		<textarea name="answer"  rows="22" cols="70"></textarea></span></b></td>
    </tr>
